...
2. Add your content image
  > What is content image? It is the image which is transfered into the style of the target image (style image).
3. Modify the path of the corresponding images to get desired result.
4. You can adjust the alpha to your liking to adjust the blend of the original image with the new stylized image.
